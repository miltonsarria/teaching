...
class secWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.connect(self.button, SIGNAL('clicked()'), self.HideWindow)
    ...
    def closeEvent(self,event):
        self.hide()
    #the same as before. function do not destroy window, just hide it using a button
    def HideWindow(self):
        self.hide()        
...
class AppForm(QMainWindow):
    ...
    def valuechange(self):
        """Actualizar y hacer algo para que cuando spinvox cambie se realice una accion
        """
